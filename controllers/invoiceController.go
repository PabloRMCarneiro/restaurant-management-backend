...
func GetInvoice() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		var invoiceView InvoiceViweFormat
...
func CreateInvoice() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		if err != nil {
			c.JSON(http.StatusInternalServerError, gin.H{"error": "Error order was no found!"})
			return
		}
		...
		if err != nil {
			c.JSON(http.StatusInternalServerError, gin.H{"error": "Error occured while creating the invoice item!"})
			return
		}
		defer cancel()
